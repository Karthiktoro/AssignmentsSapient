...
public class HomeLoan {
	...
	public HomeLoan(int loanAmount,int numberOfMonths , String person , double percentage) {
	...
	//public void interest(int loanAmount , int numberOfMonths,double percentage) {		}
